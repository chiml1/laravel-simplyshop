                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        ...
                        <form role="form" action="{{ route('orderpizza') }}" method="post" id="comment-form" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="form-group row{{$errors->has('firstName')?'has-error':''}}"><label class="col-sm-2 col-form-label">Imię*:</label><div class="col-sm-10"><input name="firstName" class="form-control"  pattern="^([A-ZĆŁŹŻŚ][a-ząęćółśźż]{1,25})$" required value="Adam"></div></div>
                            <div class="form-group row{{$errors->has('lastName')?'has-error':''}}"><label class="col-sm-2 col-form-label">Nazwisko*:</label><div class="col-sm-10"><input name="lastName" class="form-control"  pattern="^([A-ZĆŁŹŻŚ][a-ząęćółśźż]{1,40})$" required value="Adamski"></div></div>
                            <div class="form-group row{{$errors->has('phone')?'has-error':''}}"><label class="col-sm-2 col-form-label">Nr telefonu*:</label><div class="col-sm-10"><input name="phone" class="form-control" type="tel"  placeholder="444555333" pattern="[0-9]{9}"  required value="786555444"></div></div>
                            <div class="form-group row{{$errors->has('city')?'has-error':''}}"><label class="col-sm-2 col-form-label">Miasto*:</label><div class="col-sm-10"><input name="city" class="form-control"  pattern="^[a-zA-Z]+(?:[\s-][a-zA-Z]+)*$" required value="Koszalin"></div></div>
                            <div class="form-group row{{$errors->has('street')?'has-error':''}}"><label class="col-sm-2 col-form-label">Ulica*:</label><div class="col-sm-10"><input name="street" class="form-control" pattern="^([A-ZŁ][a-ząęćółśźż]{1,25})$" required value="Zielona"></div></div>
                            <div class="form-group row{{$errors->has('building_nr')?'has-error':''}}"><label class="col-sm-2 col-form-label">Nr budynku*:</label><div class="col-sm-10"><input name="building_nr" class="form-control" pattern="^([A-Za-z0-9]{1,5})$" required value="5"></div></div>
